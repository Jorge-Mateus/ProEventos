    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task<SignInResult> checkUserPasswordAsync(UserUpdateDto userUpdateDto, string password)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Erro ao tentar verificar o passaword{ex.Message}");
            }
        }
        ...
        public async Task<UserUpdateDto> CreateAccountAsync(UserDto userDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Erro ao tentar criar o conta. {ex.Message}");
            }
        }
        ...
        public async Task<bool> UserExists(string userName)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Erro ao tentar verificar se o usuário existe. {ex.Message}");
            }
        }
    }
}
